...
- **[AutoML For Time Series Forecasting](#)**
    - [Automating Time Series Forecasting with FLAML](Automating_Time_Series_Forecsting_with_FLAML.ipynb)

## Maintainer

This project is maintained by Ravi Sekhar Kommuri. Ravi is a Data Engineer with over 4 years of experience in architecting, building, and optimizing scalable data pipelines and analytics solutions. With a strong foundation in Python, SQL, and data modeling, he focuses on ensuring high availability and data integrity across enterprise environments.

For questions, contributions, or professional inquiries, feel free to reach out:

- **LinkedIn:** https://www.linkedin.com/in/ravikommuri
- **Email:** ravikommuri13@gmail.com